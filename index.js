...
const form = document.getElementById("age-form"); /*get the form*/
...
function calculateAge(e) {
  ...
  if (validateInp()) {
    ...
    let day = currentDate.getDate(); /*Get day as a number (1-31)*/
    let month =
      currentDate.getMonth() +
      1; /* Note: 0=January, 1=February because month start with index 0,so the current month is +1*/
